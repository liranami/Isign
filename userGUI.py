...
class UserGUI(Frame):
    ...
    def __init__(self, parent, controller, main):
        ...
        self.canvas.create_rectangle(9.0, 79.0, 654.0, 564.0, fill="#FFFFFF", outline="#000000")
        ...
        self.startBtn = Button(parent, image=self.startBtn_image, borderwidth=0, highlightthickness=0,
                               command=lambda: [self.startvideo(),
                                                threading.Thread(target=self.show_video).start(),threading.Thread(target=self.show_video).start()], relief="flat")
        ...
        self.goBackBtn = Button(parent, image=self.goBack_image, borderwidth=0, highlightthickness=0,
                                command=lambda: controller.show_frame(main), relief="flat")
